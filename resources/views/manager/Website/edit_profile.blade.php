...
@section('title', 'Edit Manager Profile')
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('manager_edit_profile_submit', $single_manager->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Role</label>
                                        <input type="role" class="form-control" value="Marketing Manager" readonly>
                                    </div>
                                    <label>Photo</label>
                                    ...
                                    <div class="input-group mb-3">
                                        <img src="{{ asset('/storage/uploads/' . $single_manager->photo) }}"
